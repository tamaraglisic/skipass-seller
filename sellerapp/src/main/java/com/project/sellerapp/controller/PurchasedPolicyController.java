...
public class PurchasedPolicyController {
	...
	@RequestMapping(value = "/for-tickets/{id}" , method = RequestMethod.GET)
	@PreAuthorize("hasRole('ROLE_REGISTERED_USER')")
	public ResponseEntity<List<PurchasedPolicyDTO>> getPoliciesForTickets(@PathVariable Long id){
		List<PurchasedPolicyDTO> policies = purchasedPolicyService.findByTicketsId(id);
